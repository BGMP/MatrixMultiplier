...
\begin{document}
  ...
  \centering
    \makebox[0pt]{\includegraphics[width=16cm]{DR1_PLOT.png}}
  
  \centering
    \makebox[0pt]{\includegraphics[width=16cm]{DR2_PLOT.png}}

  \centering
    \makebox[0pt]{\includegraphics[width=16cm]{DR1_DR2_PLOT.png}}
\end{document}
